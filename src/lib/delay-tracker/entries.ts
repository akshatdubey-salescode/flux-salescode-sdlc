...
// Re-exported for existing call sites — the actual implementations are
// fully generic (not delay-specific) and now live in the shared module so
// the deliveries feature can import them without a second copy drifting.
export { isValidDateString, isValidUuid, parseOptionalText } from "@/lib/validation";
