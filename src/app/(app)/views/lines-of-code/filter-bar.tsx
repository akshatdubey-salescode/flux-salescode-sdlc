  ...
  return (
    ...
    >
      ...
      <Popover
        ...
        onOpenChange={(o) => {
          setCalOpen(o);
          // Reset the picker to the active range each time it opens, so it
          // reflects whatever quarter/custom range is currently applied.
          if (o) setCalRange({ from: parseISO(start), to: parseISO(end) });
        }}
      >
